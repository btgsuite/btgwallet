...
[![Build Status](https://travis-ci.org/btgsuite/btgwallet.png?branch=master)](https://travis-ci.org/btgsuite/btgwallet)
...
can be found [here](https://github.com/btgsuite/btgd).  An alternative
...
https://github.com/btgsuite/btgwallet/releases
...
```
git clone https://github.com/btgsuite/btgwallet $GOPATH/src/github.com/btgsuite/btgwallet
cd $GOPATH/src/github.com/btgsuite/btgwallet
glide install
```
...
```bash
$ cp $GOPATH/src/github.com/btgsuite/btgd/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/btgsuite/btgwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/btgsuite/btgwallet/issues)
