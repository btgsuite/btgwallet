...
[![GoDoc](https://godoc.org/github.com/btgsuite/btgwallet/walletdb?status.png)]
(http://godoc.org/github.com/btgsuite/btgwallet/walletdb)
...
http://localhost:6060/pkg/github.com/btgsuite/btgwallet/walletdb

## Installation

```bash
$ go get github.com/btgsuite/btgwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/btgsuite/btgwallet/walletdb#example-package--BasicUsage)  
